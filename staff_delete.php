...
<html>
	<head>
		...
		<link href="staff_delete.css" rel="stylesheet">
	...
	<body>
		...
		<div class="staff_delete">スタッフ削除</div><br />
		<br />
		<div class="staff_code">スタッフコード</div><br />
		<?php print $staff_code; ?>
		<br />
		<div class="staff_name2">スタッフ名</div><br />
		<?php print $staff_name; ?>
		<br />
		<div class="staff_delete_ok">このスタッフを削除してよろしいですか？<br />
		<br />
