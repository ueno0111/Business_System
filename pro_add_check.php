...
<html>
	<head>
		...
		<link href="pro_add_check.css" rel="stylesheet">
	...
	<body>
		...
		<?php
			...
			{
				print '<div class="product_add">'.'上記の商品を追加します。<br />'.'</div>';
				print '<div class="product_name">'.'商品名'.'</div>';
				print $pro_name;
				print '<br />';
			}
			...
			{
				print '<div class="product_price">'.'価格'.'</div>';
				print $pro_price;
				print '円<br />';
			}
